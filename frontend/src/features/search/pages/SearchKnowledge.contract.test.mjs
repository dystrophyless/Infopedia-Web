...
assert.match(searchPage, /data-desktop-search-results className=\{`flex min-w-0 flex-col gap-4 \$\{selectedTermId \? 'w-full' : 'w-\[684px\]'\}\`\}/, 'search inner results list must stay 684px unselected and fill only when selected');
