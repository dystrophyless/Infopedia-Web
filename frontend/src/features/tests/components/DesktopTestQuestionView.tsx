...
export function DesktopTestQuestionView({ title, questions, state, submitting, actionError, primaryActionLabel, onExit, onSelectOption, onPrimaryAction, onGoToQuestion, onPrevious }: Props) {
