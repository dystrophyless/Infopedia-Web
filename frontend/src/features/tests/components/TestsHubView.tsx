...
export function TestsHubView({
  ...
  return (
    <div className="min-h-[calc(100dvh-80px)] bg-[#efebf6] px-6 py-12 max-md:min-h-[calc(100dvh-88px)] max-md:px-6 max-md:pb-0 max-md:pt-[90px] md:flex md:justify-center">
