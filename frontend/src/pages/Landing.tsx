            ...
            <div className="grid h-full w-full min-w-0 grid-cols-3 gap-[32px]">
              {features.map((feature) => (
                <Link
                  ...
                  className="group relative flex h-[493px] min-w-0 flex-col overflow-hidden rounded-[16px] transition-transform duration-200 ease-out hover:scale-[1.01] motion-reduce:transition-none motion-reduce:hover:scale-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#6a37c3]"
                >
