...
assert.match(termCardSource, /state=\{\{\s*backTo,\s*term,\s*selectedDefinitionPublicId:\s*definition\?\.public_id\s*\}\}/, 'Term link must preserve back navigation and the term fast path');
